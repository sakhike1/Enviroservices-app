  ...
  <div class="max-w-[85rem]  px-4 py-10 sm:px-6 lg:px-8 lg:py-14 mx-auto">
    <div data-aos="fade-up" data-aos-duration="3000" class="relative p-6 md:p-16 ">
          ...
          <div class="relative">
            ...
            <div>
              <div id="tabs-with-card-1" role="tabpanel" aria-labelledby="tabs-with-card-item-1">
                <img class="shadow-xl shadow-gray-200 rounded-xl dark:shadow-gray-900/[.4]"
                  src="https://media.istockphoto.com/id/1211762636/photo/scientist-doing-research-outdoors-wearing-white-coverall-and-gas-mask.jpg?s=612x612&w=0&k=20&c=fojpKDpQqtER-D_NRSIiEY2A3plffhcrIvYSI5GeM9g="
      ...
      <div class="absolute inset-0 grid grid-cols-12 w-full h-full">
        <div
          class="col-span-full lg:col-span-7 lg:col-start-6 bg-slate-100 w-full h-5/6 rounded-xl sm:h-3/4 lg:h-full dark:bg-white/[.075]">
        </div>
      </div>
