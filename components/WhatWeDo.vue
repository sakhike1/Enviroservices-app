<template>
  <NuxtErrorBoundary>
  <!-- Card Blog -->
  <div class="max-w-[85rem] px-4 py-20 sm:px-6 lg:px-8 lg:py-14 mx-auto">
    <!-- Title -->
    <div class="max-w-2xl mx-auto py-20 text-center mb-10 lg:mb-14">
      <h1 class="font-bold text-2xl lg:text-3xl text-green-900 dark:text-gray-400">
        
        Gathering and investigating test samples of soil, water and air.
      </h1>
    </div>
    <!-- End Title -->
